...
-   3,793 x 5 is still the size, but this would be somewhat unreadable
    as is; reminds me a bit of the way it looks in the R environment
    pane

-   read across with no order
...
-   87.6 % of the set were accurately predicted using the glm
...
-   accuracy is shown in the top row (87.6%)

-   not sure what roc_auc is
